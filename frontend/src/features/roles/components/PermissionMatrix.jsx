...
const ACTION_LABELS = {
  ...
  'amount.view': 'Savdo summasi (legacy)',
  'deposit.view': 'Zaklad summasi (legacy)',
  'phone.view': 'Telefon (legacy)',
  assign: 'Biriktirish',
  send: 'Yuborish',
  manage: 'Boshqarish',
  convert: "Aylantirish",
...
const ACTION_ORDER = ['view', 'viewAll', 'viewOwn', 'viewGroups', 'create', 'edit', 'editCore', 'viewPhone', 'viewAmount', 'viewPipelineTotal', 'viewDeposit', 'viewFinancials', 'viewCreatedBy', 'amount.view', 'deposit.view', 'phone.view', 'assign', 'changeStage', 'convert', 'send', 'manage', 'delete']
